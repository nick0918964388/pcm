...
describe('ConnectionPoolManager', () => {
  ...
  describe('Connection Pool Initialization', () => {
    ...
    it('should retry connection establishment on failure', async () => {
      ...
      // Mock 前兩次連接失敗，第三次成功
      jest
        .spyOn(connectionPoolManager as any, 'createOraclePool')
      ...
      expect(connectionPoolManager.getPoolStatus().oracle.isInitialized).toBe(
        true
      );
    });
  ...
  describe('Connection Management', () => {
    ...
    it('should support both Oracle and PostgreSQL connections', async () => {
      ...
      const oracleConnection =
        await connectionPoolManager.getConnection('oracle');
      const postgresConnection =
        await connectionPoolManager.getConnection('postgresql');
    ...
    it('should manage connection lifecycle properly', async () => {
      ...
      expect(statusAfterRelease.oracle.connectionsInUse).toBeLessThan(
        statusBeforeRelease.oracle.connectionsInUse
      );
    });
  ...
  describe('Error Handling and Resilience', () => {
    ...
    it('should implement automatic retry mechanism', async () => {
      ...
      jest
        .spyOn(connectionPoolManager as any, 'getOracleConnection')
        .mockRejectedValueOnce(mockError)
        .mockRejectedValueOnce(mockError)
    ...
    it('should return structured error information', async () => {
      ...
      await expect(
        connectionPoolManager.getConnection('oracle')
