...
describe('SignedUrlService', () => {
  ...
  describe('validateSignedUrl', () => {
    ...
    test('應該驗證IP限制', () => {
      ...
      // 測試允許的IP
      const validResult = signedUrlService.validateSignedUrl(
        url,
        '192.168.1.1'
      );
      ...
      // 測試不允許的IP
      const invalidResult = signedUrlService.validateSignedUrl(
        url,
        '192.168.1.2'
      );
  ...
  describe('validateToken', () => {
    test('應該驗證有效的token', () => {
      ...
      const { token } = signedUrlService.generateSignedUrl(
        originalUrl,
        options
      );
  ...
  describe('generatePhotoAccessUrl', () => {
    test('應該生成照片存取URL', () => {
      const result = signedUrlService.generatePhotoAccessUrl(
        'photo123',
        'user456'
      );
  ...
  describe('generateBatchDownloadUrl', () => {
    test('應該生成批次下載URL', () => {
      ...
      const result = signedUrlService.generateBatchDownloadUrl(
        photoIds,
        'user456'
      );
  ...
  describe('generateUploadUrl', () => {
    test('應該生成上傳URL', () => {
      const result = signedUrlService.generateUploadUrl(
        'project123',
        'user456'
      );
