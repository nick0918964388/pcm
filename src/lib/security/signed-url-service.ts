...
const downloadCountStore = new Map<
  string,
...
const SIGNING_SECRET =
  process.env.SIGNED_URL_SECRET || 'your-super-secret-key-change-in-production';
...
export class SignedUrlService {
   ...
   * 驗證簽名URL
   */
  validateSignedUrl(signedUrl: string, clientIP?: string): UrlValidationResult {
    try {
