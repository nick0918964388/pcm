 ...
 */
export type CreateWBSItemInput = Omit<
  WBSItem,
  | 'id'
  | 'code'
  | 'level'
 ...
 */
export type UpdateWBSItemInput = Partial<
  Omit<WBSItem, 'id' | 'projectId' | 'createdAt' | 'createdBy' | 'children'>
> & {
  id: string;
};
