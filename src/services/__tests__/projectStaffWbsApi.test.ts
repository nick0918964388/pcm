...
describe('ProjectApiServiceExtension 專案人員 API 測試', () => {
  ...
  describe('專案人員查詢功能', () => {
    ...
    it('應該處理人員查詢錯誤', async () => {
      ...
      await expect(
        apiExtension.getProjectMembers('invalid-proj')
      ).rejects.toThrow(StaffApiError);
    });
  });
  ...
  describe('專案人員管理功能', () => {
    ...
    it('應該成功更新專案人員', async () => {
      ...
      const result = await apiExtension.updateProjectMember(
        'proj-001',
        'member-001',
        updates
      );
    ...
    it('應該成功移除專案人員', async () => {
      ...
      const result = await apiExtension.removeProjectMember(
        'proj-001',
        'member-001'
      );
...
describe('ProjectApiServiceExtension WBS API 測試', () => {
  ...
  describe('WBS 樹狀結構管理', () => {
    ...
    it('應該處理 WBS 查詢錯誤', async () => {
      ...
      await expect(apiExtension.getWBSTree('proj-001')).rejects.toThrow(
        WBSApiError
      );
    });
  });
  ...
  describe('WBS 節點操作', () => {
    ...
    it('應該成功更新 WBS 項目', async () => {
      ...
      const result = await apiExtension.updateWBSItem(
        'proj-001',
        'wbs-002',
        updates
      );
    ...
    it('應該成功移動 WBS 項目', async () => {
      ...
      const result = await apiExtension.moveWBSItem(
        'proj-001',
        'wbs-002',
        'wbs-003',
        1
  ...
  describe('WBS 批次操作', () => {
    it('應該成功執行批次更新', async () => {
      ...
      const result = await apiExtension.batchUpdateWBS(
        'proj-001',
        batchRequest
      );
    ...
    it('應該成功執行批次刪除', async () => {
      ...
      const result = await apiExtension.batchDeleteWBS(
        'proj-001',
        batchRequest
      );
