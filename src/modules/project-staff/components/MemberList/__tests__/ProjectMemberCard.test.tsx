...
describe('ProjectMemberCard', () => {
  ...
  it('應該支援點擊檢視詳情', async () => {
    ...
    render(
      <ProjectMemberCard {...defaultProps} onViewDetails={onViewDetails} />
    );
  ...
  it('應該支援點擊編輯', async () => {
    ...
    render(<ProjectMemberCard {...defaultProps} onEdit={onEdit} />);
  ...
  it('應該支援點擊刪除', async () => {
    ...
    render(<ProjectMemberCard {...defaultProps} onDelete={onDelete} />);
  ...
  it('應該根據工作狀態顯示不同顏色', () => {
    ...
    const unavailableMember = {
      ...mockMember,
      workStatus: WorkStatus.UNAVAILABLE,
    };
    rerender(
      <ProjectMemberCard {...defaultProps} member={unavailableMember} />
    );
