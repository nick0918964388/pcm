...
describe('PaginationControls', () => {
  ...
  it('應該支援每頁筆數調整', () => {
    // Act
    render(<PaginationControls {...defaultProps} showPageSizeSelector />);
  ...
  it('應該支援省略號顯示', () => {
    // Act
    render(
      <PaginationControls {...defaultProps} currentPage={50} totalPages={100} />
    );
  ...
  it('應該正確處理無數據情況', () => {
    // Act
    render(
      <PaginationControls {...defaultProps} totalItems={0} totalPages={0} />
    );
