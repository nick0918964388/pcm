...
describe('FilterPanel', () => {
  ...
  it('應該支援摺疊面板', async () => {
    ...
    render(
      <FilterPanel {...defaultProps} collapsible defaultExpanded={false} />,
      { wrapper }
    );
  ...
  it('應該支援響應式布局', () => {
    ...
    // Act
    render(<FilterPanel {...defaultProps} responsive />, { wrapper });
  ...
  it('應該支援載入狀態', () => {
    ...
    // Act
    render(<FilterPanel {...defaultProps} loading />, { wrapper });
