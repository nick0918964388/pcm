...
describe('ProjectMemberFilters', () => {
  ...
  it('應該顯示已選擇的篩選器', () => {
    ...
    // Act
    render(<ProjectMemberFilters {...defaultProps} filters={filters} />);
  ...
  it('應該支援摺疊/展開篩選面板', async () => {
    // Arrange
    render(<ProjectMemberFilters {...defaultProps} collapsible />);
  ...
  it('應該支援響應式設計', () => {
    // Act
    render(<ProjectMemberFilters {...defaultProps} responsive />);
