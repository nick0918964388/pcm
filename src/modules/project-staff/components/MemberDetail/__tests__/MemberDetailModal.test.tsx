...
describe('MemberDetailModal', () => {
  ...
  it('應該顯示錯誤狀態', () => {
    // Act
    render(<MemberDetailModal {...defaultProps} error='載入失敗' />);
  ...
  it('應該支援聯絡方式顯示', () => {
    ...
    // Act
    render(<MemberDetailModal {...defaultProps} member={memberWithContact} />);
  ...
  it('應該支援發送訊息功能', async () => {
    ...
    render(
      <MemberDetailModal {...defaultProps} onSendMessage={onSendMessage} />
    );
