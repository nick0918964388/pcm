...
describe('MemberActionMenu', () => {
  ...
  it('應該支援檢視詳情操作', async () => {
    ...
    render(
      <MemberActionMenu {...defaultProps} onViewDetails={onViewDetails} />
    );
  ...
  it('應該支援發送訊息操作', async () => {
    ...
    render(
      <MemberActionMenu {...defaultProps} onSendMessage={onSendMessage} />
    );
  ...
  it('應該支援自訂觸發器', () => {
    // Act
    render(
      <MemberActionMenu {...defaultProps} trigger={<button>自訂按鈕</button>} />
    );
