...
const createMockPermissions = (userIds: string[]): ProjectPermission[] => {
  return userIds.map((userId, index) => ({
    userId,
    level: index === 0 ? PermissionLevel.ADMIN : 
           index === 1 ? PermissionLevel.WRITE : PermissionLevel.READ,
...
export const mockProjects: Project[] = [
  // === 台北捷運項目 ===
  {
    ...
    code: 'F20P1',
    name: '台北捷運信義線延伸工程',
    description: '台北捷運信義線由象山站延伸至信義區東側，新增3站點，總長度約4.8公里，包含地下段及高架段建設。',
    ...
    managerId: 'mgr001',
    managerName: '蔡志強',
    teamMembers: [mockTeamMembers[0], mockTeamMembers[1], mockTeamMembers[2], mockTeamMembers[5]],
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/3B82F6/FFFFFF?text=捷運建設',
  ...
  // === 高雄輕軌項目 ===
  {
    ...
    code: 'F22P4',
    name: '高雄輕軌環狀線建設',
    description: '高雄輕軌環狀線第二階段工程，連接愛河兩岸，包含12個車站及相關配套設施建設。',
    ...
    managerId: 'mgr002',
    managerName: '林美惠',
    teamMembers: [mockTeamMembers[1], mockTeamMembers[3], mockTeamMembers[4], mockTeamMembers[6]],
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/10B981/FFFFFF?text=輕軌建設',
  ...
  // === 台中捷運項目 ===
  {
    ...
    code: 'F23P7',
    name: '台中捷運綠線延伸段',
    description: '台中捷運綠線北延段工程，從北屯總站延伸至彰化縣界，新增8個車站。',
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/8B5CF6/FFFFFF?text=捷運規劃',
    tags: ['捷運', '延伸線', '跨縣市', '環評中'],
    location: '台中市北屯區',
    client: '台中市政府交通局',
    notes: '目前進行環境影響評估階段',
  ...
  // === 桃園機場項目 ===
  {
    ...
    code: 'F21P9',
    name: '桃園機場第三航廈建設',
    description: '桃園國際機場第三航廈主體建築及相關配套設施建設，包含航廈大樓、停機坪、聯絡橋等。',
    status: ProjectStatus.IN_PROGRESS,
    ...
    managerId: 'mgr004',
    managerName: '王大明',
    teamMembers: [mockTeamMembers[3], mockTeamMembers[4], mockTeamMembers[5], mockTeamMembers[6], mockTeamMembers[7]],
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/F59E0B/FFFFFF?text=機場建設',
  ...
  // === 南迴公路項目 ===
  {
    ...
    code: 'F19P3',
    name: '南迴公路拓寬改善工程',
    description: '台9線南迴公路段拓寬改善，全長約40公里，包含隧道、橋樑及路面改善工程。',
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/EF4444/FFFFFF?text=公路工程',
  ...
  // === 台北社會住宅項目 ===
  {
    ...
    code: 'F24P2',
    name: '台北市南港社會住宅建設',
    description: '南港區社會住宅新建工程，規劃400戶住宅單位及公共設施，採綠建築設計。',
    status: ProjectStatus.IN_PROGRESS,
    type: ProjectType.CONSTRUCTION,
    progress: 32,
    ...
    managerId: 'mgr006',
    managerName: '張文華',
    teamMembers: [mockTeamMembers[0], mockTeamMembers[2], mockTeamMembers[5], mockTeamMembers[7]],
    ...
    updatedAt: new Date('2025-08-28'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/06B6D4/FFFFFF?text=住宅建設',
  ...
  // === 高雄港區項目 ===
  {
    ...
    code: 'F20P8',
    name: '高雄港洲際貨櫃中心二期擴建',
    description: '高雄港洲際貨櫃中心第二期擴建工程，新增6個貨櫃碼頭泊位及相關設施。',
    status: ProjectStatus.COMPLETED,
    type: ProjectType.INFRASTRUCTURE,
    progress: 100,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/F97316/FFFFFF?text=港口建設',
    tags: ['港口', '貨櫃', '海運', '國際貿易'],
    location: '高雄市小港區',
    client: '台灣港務股份有限公司',
  ...
  // === 台中水湳項目 ===
  {
    ...
    description: '台中水湳智慧城中央公園景觀改善工程，包含植栽、步道、水景及智慧設施建置。',
    status: ProjectStatus.IN_PROGRESS,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/84CC16/FFFFFF?text=景觀工程',
    tags: ['景觀', '智慧城市', '公園', '綠化'],
    location: '台中市西屯區',
    client: '台中市政府建設局',
    notes: '配合智慧城市發展計畫進行',
  ...
  // === 新竹科學園區項目 ===
  {
    ...
    code: 'F24P6',
    name: '新竹科學園區三期開發工程',
    description: '新竹科學園區第三期擴建工程，包含廠房、道路、管線及綠能設施建設。',
    status: ProjectStatus.PLANNING,
    type: ProjectType.INFRASTRUCTURE,
    progress: 8,
    ...
    updatedAt: new Date('2025-08-29'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/6366F1/FFFFFF?text=科技園區',
  ...
  // === 嘉義高鐵項目 ===
  {
    ...
    code: 'F21P6',
    name: '嘉義高鐵特定區聯外道路改善',
    description: '嘉義高鐵特定區聯外道路系統改善工程，包含道路拓寬、交流道改建及號誌系統更新。',
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/6B7280/FFFFFF?text=取消專案',
    tags: ['道路', '高鐵', '聯外交通', '已取消'],
    location: '嘉義縣太保市',
    client: '嘉義縣政府',
  ...
  // === 台南古蹟維護項目 ===
  {
    ...
    code: 'F22P11',
    name: '台南赤崁樓古蹟維護工程',
    description: '國定古蹟赤崁樓結構補強及文物保存環境改善工程，包含建築修復及展示設施更新。',
    status: ProjectStatus.IN_PROGRESS,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/DC2626/FFFFFF?text=古蹟維護',
    tags: ['古蹟', '文化資產', '維護', '觀光'],
    location: '台南市中西區',
    client: '台南市政府文化局',
  ...
  // === 花蓮太魯閣項目 ===
  {
    ...
    code: 'F23P9',
    name: '太魯閣國家公園步道設施改善',
    description: '太魯閣國家公園主要登山步道設施改善工程，包含安全設施、指標系統及休憩設施更新。',
    status: ProjectStatus.IN_PROGRESS,
    type: ProjectType.RENOVATION,
    progress: 55,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/059669/FFFFFF?text=國家公園',
  ...
  // === 屏東農業設施項目 ===
  {
    ...
    code: 'F24P8',
    name: '屏東農業科技園區溫室設施建設',
    description: '屏東農業科技園區智慧溫室及相關農業設施建設，包含自動化設備及綠能系統。',
    status: ProjectStatus.PLANNING,
    type: ProjectType.CONSTRUCTION,
    progress: 12,
    startDate: new Date('2025-01-01'),
    ...
    updatedAt: new Date('2025-08-27'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/16A34A/FFFFFF?text=農業設施',
    tags: ['農業', '智慧溫室', '科技', '綠能'],
    location: '屏東縣長治鄉',
    client: '屏東縣政府農業處',
    notes: '結合AI技術發展精緻農業',
  ...
  // === 基隆港務項目 ===
  {
    ...
    code: 'F20P12',
    name: '基隆港東岸碼頭改建工程',
    description: '基隆港東岸碼頭設施改建及現代化工程，提升港口作業效率及安全性。',
    status: ProjectStatus.COMPLETED,
    type: ProjectType.RENOVATION,
    progress: 100,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/7C3AED/FFFFFF?text=港口改建',
    tags: ['港口', '碼頭', '海運', '現代化'],
    location: '基隆市中正區',
  ...
  // === 雲林離岸風電項目 ===
  {
    ...
    code: 'F23P12',
    name: '雲林離岸風電場陸域設施建設',
    description: '雲林離岸風電場陸域變電站及輸電設施建設工程，包含海纜登陸點及維運基地。',
    status: ProjectStatus.IN_PROGRESS,
    type: ProjectType.INFRASTRUCTURE,
    progress: 41,
    ...
    managerId: 'mgr015',
    managerName: '吳建志',
    teamMembers: [mockTeamMembers[0], mockTeamMembers[3], mockTeamMembers[5], mockTeamMembers[6]],
    ...
    updatedAt: new Date('2025-08-29'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/0EA5E9/FFFFFF?text=再生能源',
  ...
  // === 澎湖觀光設施項目 ===
  {
    ...
    code: 'F24P10',
    name: '澎湖跨海大橋景觀改善工程',
    description: '澎湖跨海大橋及周邊觀光設施景觀改善工程，包含橋體美化、觀景台及停車場建設。',
    status: ProjectStatus.PLANNING,
    type: ProjectType.RENOVATION,
    progress: 5,
    ...
    updatedAt: new Date('2025-08-26'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/F472B6/FFFFFF?text=觀光設施',
    tags: ['觀光', '景觀', '橋樑', '離島建設'],
    location: '澎湖縣白沙鄉',
    client: '澎湖縣政府觀光處',
    notes: '配合離島觀光發展計畫執行',
  ...
  // === 新北市學校建設項目 ===
  {
    ...
    code: 'F23P15',
    name: '新北市板橋區國小校舍重建工程',
    description: '新北市板橋區某國小老舊校舍拆除重建工程，包含教學大樓、體育館及附屬設施。',
    status: ProjectStatus.IN_PROGRESS,
    type: ProjectType.CONSTRUCTION,
    progress: 63,
    ...
    managerId: 'mgr017',
    managerName: '劉志明',
    teamMembers: [mockTeamMembers[0], mockTeamMembers[2], mockTeamMembers[4], mockTeamMembers[6]],
    ...
    updatedAt: new Date('2025-08-28'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/3B82F6/FFFFFF?text=學校建設',
    tags: ['學校', '教育', '重建', '公共建設'],
    location: '新北市板橋區',
    client: '新北市政府教育局',
    notes: '配合學期安排調整施工時程',
  ...
  // === 宜蘭溫泉區項目 ===
  {
    ...
    code: 'F22P18',
    name: '宜蘭礁溪溫泉區管線更新工程',
    description: '宜蘭礁溪溫泉區溫泉供應管線及配套設施更新工程，提升供水品質及系統可靠性。',
    status: ProjectStatus.COMPLETED,
    type: ProjectType.MAINTENANCE,
    progress: 100,
    ...
    thumbnailUrl: 'https://via.placeholder.com/300x200/F59E0B/FFFFFF?text=溫泉設施',
    tags: ['溫泉', '管線', '觀光', '維護'],
    location: '宜蘭縣礁溪鄉',
    client: '宜蘭縣政府工務處',
  ...
  // === 金門保育項目 ===
  {
    ...
    code: 'F24P14',
    name: '金門國家公園生態保育設施建設',
    description: '金門國家公園生態保育設施及環境教育中心建設工程，包含觀察站、步道及解說設施。',
    status: ProjectStatus.PLANNING,
    type: ProjectType.CONSTRUCTION,
    progress: 3,
    ...
    updatedAt: new Date('2025-08-25'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/065F46/FFFFFF?text=生態保育',
  ...
  // === 苗栗產業園區項目 ===
  {
    ...
    code: 'F23P20',
    name: '苗栗頭份產業園區基礎設施建設',
    description: '苗栗頭份產業園區基礎設施建設工程，包含道路、管線、污水處理及綠地規劃。',
    status: ProjectStatus.IN_PROGRESS,
    type: ProjectType.INFRASTRUCTURE,
    progress: 29,
    ...
    managerId: 'mgr020',
    managerName: '楊國強',
    teamMembers: [mockTeamMembers[0], mockTeamMembers[1], mockTeamMembers[4], mockTeamMembers[5]],
    ...
    updatedAt: new Date('2025-08-29'),
    thumbnailUrl: 'https://via.placeholder.com/300x200/7C2D12/FFFFFF?text=產業園區',
...
export const mockProjectSummary = {
  ...
  projectsByStatus: {
    [ProjectStatus.PLANNING]: mockProjects.filter(p => p.status === ProjectStatus.PLANNING).length,
    [ProjectStatus.IN_PROGRESS]: mockProjects.filter(p => p.status === ProjectStatus.IN_PROGRESS).length,
    [ProjectStatus.PAUSED]: mockProjects.filter(p => p.status === ProjectStatus.PAUSED).length,
    [ProjectStatus.COMPLETED]: mockProjects.filter(p => p.status === ProjectStatus.COMPLETED).length,
    [ProjectStatus.CANCELLED]: mockProjects.filter(p => p.status === ProjectStatus.CANCELLED).length,
  },
  projectsByType: {
    [ProjectType.CONSTRUCTION]: mockProjects.filter(p => p.type === ProjectType.CONSTRUCTION).length,
    [ProjectType.INFRASTRUCTURE]: mockProjects.filter(p => p.type === ProjectType.INFRASTRUCTURE).length,
    [ProjectType.RENOVATION]: mockProjects.filter(p => p.type === ProjectType.RENOVATION).length,
    [ProjectType.MAINTENANCE]: mockProjects.filter(p => p.type === ProjectType.MAINTENANCE).length,
  },
...
export const mockProjectStatistics: ProjectStatistics = {
  ...
  pausedProjects: mockProjects.filter(p => p.status === ProjectStatus.PAUSED).length,
  cancelledProjects: mockProjects.filter(p => p.status === ProjectStatus.CANCELLED).length,
  ...
  budgetUtilization: Math.round(
    (mockProjects.reduce((sum, p) => sum + p.usedBudget, 0) /
     mockProjects.reduce((sum, p) => sum + p.totalBudget, 0)) * 100
  ),
}
