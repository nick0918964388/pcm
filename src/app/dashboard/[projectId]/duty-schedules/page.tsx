...
import {
  useDutySchedules,
  useCurrentDuty,
  useDutyScheduleExport,
  useDutyContact,
} from '@/lib/hooks/useDutySchedules';
import {
  DutySchedule,
  DutyScheduleFilters,
  DutyScheduleSort,
...
export default function VendorDutySchedulePage() {
  ...
  const handleQuickFilter = (
    filterType: 'today' | 'tomorrow' | 'thisWeek' | 'currentOnly'
  ) => {
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='mt-1 text-sm text-gray-600'>
                ...
                {hasData && (
                  <span className='ml-2'>
                    • 共 {pagination.total} 筆排班記錄 • {totalOnDuty} 人值班中
                  </span>
                )}
              </p>
            </div>
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='flex items-center mt-2'>
                          <Badge
                            style={{
                              backgroundColor:
                                DUTY_STATUS_COLORS[schedule.status],
                            }}
                          ...
                          <span className='ml-2 text-xs text-gray-500'>
                            {WORK_AREA_ICONS[schedule.workArea]}{' '}
                            {schedule.workArea}
                          </span>
                        </div>
                      </div>
