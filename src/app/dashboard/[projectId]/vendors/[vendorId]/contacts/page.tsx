...
export default function VendorContactsPage() {
  ...
  // 狀態管理
  const [selectedContact, setSelectedContact] = useState<VendorContact | null>(
    null
  );
  ...
  useEffect(() => {
    if (!contactsLoading && contacts.length > 0 && vendor?.name) {
      toast.success(
        `找到 ${vendor.name} 的 ${contactPagination.total} 筆聯絡人資料`
      );
    }
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
        ...
        <div className='w-full'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <Button size='sm' onClick={handleAddContact} disabled={loading}>
      ...
      <div className='w-full px-6 py-6 space-y-6'>
        {/* 廠商資訊卡片 */}
        {vendor && !vendorLoading && <VendorInfo vendor={vendor} />}
