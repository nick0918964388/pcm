...
export const SearchFilter: React.FC<SearchFilterProps> = ({
   ...
   */
  const handleProgressRangeChange = useCallback(
    ...
    >
      ...
      >
        ...
        {availableManagers.length > 0 && (
          <div
            className={cn('min-w-[200px]', layout === 'vertical' && 'w-full')}
          >
            <Select
              label='專案經理'
              placeholder='選擇專案經理...'
        ...
        <div
          className={cn('flex space-x-2', layout === 'vertical' && 'w-full')}
        >
      ...
      {hasActiveFilters && (
        <div className='mt-4 pt-4 border-t border-gray-200'>
          <div className='flex flex-wrap gap-2'>
            ...
            {filters.managerId &&
              availableManagers.find(m => m.id === filters.managerId) && (
