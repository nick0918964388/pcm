...
const EmptyState = React.memo<{ onRetry?: () => void }>(({ onRetry }) => (
  <div className='col-span-full flex flex-col items-center justify-center py-12 text-center'>
    ...
    <h3 className='text-lg font-semibold text-foreground mb-2'>沒有找到專案</h3>
...
export const ProjectGrid = React.memo<ProjectGridProps>(
  ({
    ...
    return (
      <div
        className={cn('project-grid w-full', className)}
        role='grid'
        aria-label='專案網格'
      ...
      >
        {/* 錯誤狀態 */}
        {error && (
          <div className={cn('grid gap-6 mb-6', 'grid-cols-1')}>
