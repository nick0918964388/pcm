...
export function DutyScheduleFilters({
  ...
  const getFilterCount = () => {
    ...
    Object.entries(filters).forEach(([key, value]) => {
      if (key === 'dateRange' && value && ((value as any).from || (value as any).to)) {
        count++
        ...
        {hasActiveFilters && (
          <div className="flex flex-wrap gap-2 pt-2">
            ...
            {filters.dateRange && (filters.dateRange.from || filters.dateRange.to) && (
              <Badge variant="secondary" className="text-xs">
                日期範圍: {filters.dateRange.from ? format(filters.dateRange.from, 'MM/dd', { locale: zhTW }) : '?'} - {filters.dateRange.to ? format(filters.dateRange.to, 'MM/dd', { locale: zhTW }) : '?'}
                <button
            ...
            {filters.specificDate && (
              <Badge variant="secondary" className="text-xs">
                特定日期: {format(filters.specificDate, 'MM/dd', { locale: zhTW })}
                <button
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  {filters.dateRange?.from ? (
                    filters.dateRange.to ? (
                      <>
                        {format(filters.dateRange.from, 'yyyy/MM/dd', { locale: zhTW })} - {' '}
                        {format(filters.dateRange.to, 'yyyy/MM/dd', { locale: zhTW })}
                      </>
                    ) : (
                      format(filters.dateRange.from, 'yyyy/MM/dd', { locale: zhTW })
                    )
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => handleArraySelectChange('shiftTypes', value, ShiftType)}>
              <SelectTrigger>
          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleArraySelectChange('statuses', value, DutyStatus)}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleArraySelectChange('workAreas', value, WorkArea)}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleArraySelectChange('vendorTypes', value, VendorType)}>
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => handleArraySelectChange('urgencyLevels', value, UrgencyLevel)}>
                  <SelectTrigger>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="currentOnly" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  僅顯示當前值班
                </label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor="includeReplacements" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  包含代班記錄
                </label>
              </div>
            </div>
