...
function getOptimizedImageUrl(
  ...
  if (!isOnline) {
    // 離線模式使用快取或預設圖片
    return originalUrl.includes('blob:')
      ? originalUrl
        ...
        <div className='mb-4 p-3 bg-blue-100 border border-blue-300 rounded-lg'>
          <div className='flex items-center justify-between'>
            <div
              ...
              data-testid='network-speed-indicator'
            >
            ...
            {showDataSaver && (
              <span
                ...
                data-testid='data-saver-indicator'
              >
                數據節省模式已啟用
              </span>
            )}
        ...
        {photos.map((photo, index) => {
          ...
          return (
            <div key={photo.id} className='relative'>
              ...
              {isSelected && (
                <div
                  data-testid={`photo-${photo.id}-selected`}
                  className='hidden'
                />
              )}
            </div>
