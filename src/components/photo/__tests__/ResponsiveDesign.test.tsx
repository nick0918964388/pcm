...
describe('ResponsiveDesign', () => {
  ...
  describe('Mobile Touch Interactions', () => {
    test('should handle swipe gestures on mobile lightbox', async () => {
      ...
      const swipeRightStart = createTouchEvent('touchstart', [{ clientX: 100, clientY: 300 }])
      const swipeRightMove = createTouchEvent('touchmove', [{ clientX: 250, clientY: 300 }])
      ...
      expect(lightboxContainer).toHaveAttribute('data-swipe-direction', 'right')
    })
    ...
    test('should handle tap-to-close on mobile', async () => {
      ...
      const doubleTap = createTouchEvent('touchend', [{ clientX: 100, clientY: 100 }])
  ...
  describe('Touch Gesture Recognition', () => {
    test('should detect vertical swipe for dismissal', async () => {
      ...
      // Vertical swipe down
      const swipeStart = createTouchEvent('touchstart', [{ clientX: 200, clientY: 100 }])
      const swipeMove = createTouchEvent('touchmove', [{ clientX: 200, clientY: 300 }])
    ...
    test('should handle edge cases for touch gestures', () => {
      ...
      const minimalSwipe = createTouchEvent('touchstart', [{ clientX: 200, clientY: 300 }])
      const minimalMove = createTouchEvent('touchmove', [{ clientX: 205, clientY: 300 }])
