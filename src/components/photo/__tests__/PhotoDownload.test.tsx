...
describe('PhotoDownload 元件', () => {
  ...
  it('應該在選擇解析度後開始下載', async () => {
    // Arrange
    const user = userEvent.setup()
    const mockDownloadService = require('../../../services/photoDownloadService').PhotoDownloadService

    mockDownloadService.prototype.validateDownloadPermissions.mockResolvedValue(true)
  ...
  it('應該在權限不足時顯示錯誤訊息', async () => {
    ...
    mockDownloadService.prototype.validateDownloadPermissions.mockResolvedValue(false)
