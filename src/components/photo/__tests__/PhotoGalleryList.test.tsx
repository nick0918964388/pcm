...
describe('PhotoGalleryList', () => {
  ...
  describe('選取行為', () => {
    ...
    it('當選擇特定相簿時，該相簿應該是活躍狀態', () => {
      ...
      const selectedAlbum = screen.getByRole('button', {
        name: /施工進度照片/,
      });
    ...
    it('點擊"所有照片"應該觸發 onAlbumSelect(null)', () => {
      ...
      render(
        <PhotoGalleryList {...defaultProps} onAlbumSelect={mockOnAlbumSelect} />
      );
  ...
  describe('空狀態', () => {
    it('當沒有相簿時應該顯示空狀態提示', () => {
      ...
      expect(
        screen.getByText('點擊上方按鈕建立第一個相簿')
      ).toBeInTheDocument();
    });
  ...
  describe('相簿管理功能', () => {
    it('應該顯示新增相簿按鈕', () => {
      ...
      expect(
        screen.getByRole('button', { name: /新增相簿/ })
      ).toBeInTheDocument();
    });
    ...
    it('點擊新增相簿按鈕應該觸發 onAlbumCreate', () => {
      ...
      render(
        <PhotoGalleryList {...defaultProps} onAlbumCreate={mockOnAlbumCreate} />
      );
    ...
    it('點擊刪除相簿應該觸發確認對話框', async () => {
      ...
      render(
        <PhotoGalleryList {...defaultProps} onAlbumDelete={mockOnAlbumDelete} />
      );
  ...
  describe('效能優化', () => {
    it('相簿列表應該使用虛擬化或備忘化', () => {
      ...
      const { rerender } = render(
        <PhotoGalleryList {...defaultProps} albums={manyAlbums} />
      );
  ...
  describe('權限過濾功能', () => {
    ...
    it('應該只顯示有檢視權限的相簿', () => {
      render(
        <PhotoGalleryList {...defaultProps} userPermissions={mockPermissions} />
      );
