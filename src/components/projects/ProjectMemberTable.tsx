          ...
          {members.map((member) => (
            <React.Fragment key={member.id}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full transition-all ${
                          ...
                          member.workload >= 80 ? 'bg-yellow-600' : 'bg-green-600'
                        }`}
              ...
              {expandedMember === member.id && (
                <TableRow>
                  <TableCell colSpan={enableBatchSelection ? 8 : 7} className="bg-gray-50">
                    <div className="py-2">
                      <div className="text-sm font-medium text-gray-700 mb-2">專業技能</div>
