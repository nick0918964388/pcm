...
export function ProjectMemberFilters({
  ...
  const activeFiltersCount = useMemo(() => {
    ...
    if (
      filters.workloadRange &&
      (filters.workloadRange.min || filters.workloadRange.max)
    )
      count++;
    if (
  ...
  const updateFilter = useCallback(
    (key: keyof ProjectMemberSearchParams, value: any) => {
      onFiltersChange({
        ...filters,
        [key]: value,
      });
  ...
  const removeFilter = useCallback(
    (key: keyof ProjectMemberSearchParams) => {
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    updateFilter('workStatus', value || undefined)
                  }
                >
                  <SelectTrigger>
                    ...
                    {skillOptions.map(option => (
                      ...
                      >
                        <Checkbox
                          ...
                          checked={
                            filters.skills?.includes(option.value) || false
                          }
                          onCheckedChange={() =>
                            handleSkillToggle(option.value)
                          }
                        />
                        <Label
        ...
        <div className='flex items-center space-x-1 flex-wrap'>
          ...
          {filters.workStatus && (
            <Badge variant='secondary' className='flex items-center space-x-1'>
              <span className='text-xs'>
                狀態:{' '}
                {WORK_STATUS_OPTIONS.find(s => s.value === filters.workStatus)
                  ?.label || filters.workStatus}
              </span>
              <Button
                variant='ghost'
                size='sm'
