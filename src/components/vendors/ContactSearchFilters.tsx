...
export function ContactSearchFilters({
  ...
  const hasActiveFilters = Object.entries(filters).some(([key, value]) => 
    key !== 'vendorId' && value !== undefined && value !== '' && 
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => handleSelectChange('isPrimary', value)}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => handleSelectChange('isActive', value)}>
              <SelectTrigger>
        ...
        <div className="flex items-center gap-3 pt-4 border-t">
          ...
          {hasActiveFilters && (
            <div className="text-xs text-gray-500 ml-auto">
              已套用 {Object.entries(filters).filter(([key, v]) => 
                key !== 'vendorId' && v !== undefined && v !== '' && 
