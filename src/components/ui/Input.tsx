...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseStyles =
      'w-full px-3 py-2 border rounded-lg text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand-primary focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed';
