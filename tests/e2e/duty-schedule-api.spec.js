...
test.describe('值班排程 API 測試', () => {
  ...
  test('建立新排程', async ({ request }) => {
    ...
    const response = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules`, {
      data: scheduleData,
      headers: {
  ...
  test('取得排程列表', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules?page=1&limit=10`);
  ...
  test('根據班別篩選排程', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules?shiftType=day`);
  ...
  test('根據狀態篩選排程', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules?status=已排班`);
  ...
  test('取得當前值班人員', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/current`);
  ...
  test('取得排程統計資料', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/stats`);
  ...
  test('更新排程', async ({ request }) => {
    ...
    const createResponse = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules`, {
      data: scheduleData
    });
    ...
    const response = await request.put(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/${createdSchedule.id}`, {
      data: updateData
    });
  ...
  test('值班簽到', async ({ request }) => {
    ...
    const response = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/${createdSchedule.id}/checkin`, {
      data: {
  ...
  test('值班簽退', async ({ request }) => {
    ...
    // 先簽到
    await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/${createdSchedule.id}/checkin`);
    
    // 執行簽退
    const checkOutTime = new Date();
    const response = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/${createdSchedule.id}/checkout`, {
      data: {
  ...
  test('匯出排程資料 (JSON)', async ({ request }) => {
    const response = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/export?format=json`);
  ...
  test('匯出排程資料 (CSV)', async ({ request }) => {
    const response = await request.post(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/export?format=csv`);
  ...
  test('刪除排程', async ({ request }) => {
    ...
    // 刪除排程
    const response = await request.delete(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/${createdSchedule.id}`);
  ...
  test('驗證錯誤處理 - 不存在的排程', async ({ request }) => {
    const response = await request.get(`${BASE_URL}/api/projects/${TEST_PROJECT_ID}/duty-schedules/non-existent-id`);
