...
test.describe('廠商管理 API 測試', () => {
  ...
  test('取得廠商列表', async ({ request }) => {
    const response = await request.get(
      `${BASE_URL}/api/vendors?page=1&limit=10`
    );
  ...
  test('根據類型篩選廠商', async ({ request }) => {
    const response = await request.get(
      `${BASE_URL}/api/vendors?types=contractor`
    );
  ...
  test('取得廠商詳情', async ({ request }) => {
    ...
    // 取得廠商詳情
    const response = await request.get(
      `${BASE_URL}/api/vendors/${createdVendor.id}`
    );
  ...
  test('更新廠商評分', async ({ request }) => {
    ...
    const response = await request.put(
      `${BASE_URL}/api/vendors/${createdVendor.id}/rating`,
      {
        data: ratingData,
      }
    );
  ...
  test('更新廠商狀態', async ({ request }) => {
    ...
    const response = await request.put(
      `${BASE_URL}/api/vendors/${createdVendor.id}/status`,
      {
        data: statusData,
      }
    );
  ...
  test('驗證錯誤處理 - 不存在的廠商', async ({ request }) => {
    const response = await request.get(
      `${BASE_URL}/api/vendors/non-existent-id`
    );
