# project-selection - Task 3

Execute task 3 for the project-selection specification.

## Task Description
Create mock project data in src/mocks/projects.ts

## Code Reuse
**Leverage existing code**: src/types/project.ts

## Requirements Reference
**Requirements**: US1 (AC1.2), US3 (AC3.1, AC3.2)
...
Execute with @spec-task-executor agent the following task: "Create mock project data in src/mocks/projects.ts"

```
Use the @spec-task-executor agent to implement task 3: "Create mock project data in src/mocks/projects.ts" for the project-selection specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create mock project data in src/mocks/projects.ts
- Leverage: src/types/project.ts
- Requirements: US1 (AC1.2), US3 (AC3.1, AC3.2)

## Instructions
- Implement ONLY task 3: "Create mock project data in src/mocks/projects.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks project-selection 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks project-selection 3 --mode complete
```
