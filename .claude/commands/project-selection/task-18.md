# project-selection - Task 18

Execute task 18 for the project-selection specification.

## Task Description
Add MSW server setup in src/mocks/server.ts

## Code Reuse
**Leverage existing code**: src/mocks/handlers.ts
...
## Usage
```
/Task:18-project-selection
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add MSW server setup in src/mocks/server.ts"

```
Use the @spec-task-executor agent to implement task 18: "Add MSW server setup in src/mocks/server.ts" for the project-selection specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Add MSW server setup in src/mocks/server.ts
- Leverage: src/mocks/handlers.ts
- Requirements: US6 (AC6.1, AC6.2)

## Instructions
- Implement ONLY task 18: "Add MSW server setup in src/mocks/server.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks project-selection 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks project-selection 18 --mode complete
```
