# project-selection - Task 8

Execute task 8 for the project-selection specification.

## Task Description
Create ViewModeToggle component in src/app/projects/components/ViewModeToggle.tsx
...
## Usage
```
/Task:8-project-selection
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ViewModeToggle component in src/app/projects/components/ViewModeToggle.tsx"

```
Use the @spec-task-executor agent to implement task 8: "Create ViewModeToggle component in src/app/projects/components/ViewModeToggle.tsx" for the project-selection specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: Create ViewModeToggle component in src/app/projects/components/ViewModeToggle.tsx
- Leverage: src/components/ui/button.tsx
- Requirements: US1 (AC1.3), US4 (AC4.1, AC4.2)

## Instructions
- Implement ONLY task 8: "Create ViewModeToggle component in src/app/projects/components/ViewModeToggle.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks project-selection 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks project-selection 8 --mode complete
```
